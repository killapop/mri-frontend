export const personalStatements_2 = {
  schema: {
    ...
    properties: {
      personal_background: {
        ...
        properties: {
          ...
          emergency_contact: {
            ...
            description:
              "(Please ensure that all of your referees agree to disclose their personal data and that they also have received the enclosed data protection information. Emergency contacts are, informed, a.o., in case of disease or accidents or other unforeseen circumstances occurring during your residence.)",
            properties: {
              title: {
                type: "string",
                title: "Title",
          ...
          languages: {
            ...
            description: "list languages for each ability separated by commas",
            properties: {
      ...
      scholarship: {
        type: "object",
        title: "2. Type of scholarship",
        description:
          "You are applying for a scholarship with a host organisation in a safe country in your region of origin (3-6 months). For further information on what the scholarship entails and what host organisations do, please take a look at our website: https://www.martin-roth-initiative.de/en/application-process . <p>Please note that you can apply without suggesting a host organsiation. </p>Indicate your preferred destination country/countries within your region of origin here, stating the reasons for your choice and  bearing in mind the visa regulations for these countries. Please also state the reasons for your choice and note that the Martin Roth-Initiative cannot guarantee a placement in one of these countries.",
        properties: {
          contact_details: {
            type: "object",
            title: "2.1. Contact details of suggested host organisation",
            description:
              "(only to be completed if you are already in contact with an organisation) ",
            properties: {
          ...
          rest_and_respite: {
            type: "object",
            title: "2.3 Rest and Respite",
            description:
              "(only to be completed if you are applying for a „Rest & Respite“-residence)",
            properties: {
              planning: {
                type: "string",
                title:
      ...
      artistic_work: {
        ...
        properties: {
          genre: {
            ...
            description: "Please state the artistic/cultural genre you work in",
            maxLength: 1500,
          },
          focus: {
            type: "string",
      ...
      scholarship_period: {
        type: "object",
        title:
          "5. PERIOD DURING THE SCHOLARSHIP/PERIOD FOLLOWING THE SCHOLARSHIP",
        properties: {
          artistic_goal: {
            type: "string",
