export const form = {
  ...
  PP_1_overview_funding_period: "Geplanter Förderzeitraum",
  PP_1_overview_funding_period_description:
    "Beachten Sie, dass Projektausgaben nur als zuschussfähig anerkannt werden können, wenn sie innerhalb des beantragten Förderzeitraums entstanden sind. Deshalb ist bei der Festlegung des geplanten Stipendienzeitraums wichtig, etwaige Vor- und Nachbereitungszeit mit zu berücksichtigen. Wir empfehlen daher neben der Stipendienlaufzeit eine max. zweimonatige Vorbereitungs- (für Visa- und Reisevorbereitungen) und eine max. einmonatige Nachbereitungszeit einzuplanen.",
  ...
  common_profession: "Beruf",
  common_place: "Ort",
  common_submit: "Senden",
  common_finalize: "Finalisieren",
  common_save_close: "Speichern und schließen",
  ...
  PP_1_project_impact_title: "3.3. Wirkung (gesellschaftlicher Beitrag):",
  common_cancel: "Abbrechen",
  common_printPDF: "als PDF drucken",
  PS_1_title: "Personal Statement",
  PS_1_description:
    "Liebe:r Bewerber:in,<br><br/>bevor Sie mit dem Ausfüllen des Personal Statements beginnen, lesen Sie bitte sorgfältig die folgenden allgemeinen Informationen über das Stipendienprogramm der Martin Roth-Initiative (MRI)<br><br/>Sie bewerben sich um ein MRI-Stipendium und einen zeitlich begrenzten Aufenthalt bei einer gastgebenden Kultureinrichtung (Gastorganisation) in Deutschland. Bitte beachten Sie, dass die maximale Dauer der Stipendienlaufzeit 12 Monate beträgt. In besonderen Ausnahmefällen kann dieser Zeitraum um bis zu weitere 12 Monate verlängert werden.<br><br/>Bitte beachten Sie, dass Ihre potenzielle Gastorganisation zusätzlich zu diesem Personal Statement ein vollständig ausgefülltes Antragsformular einreichen muss. Dieser Antrag umfasst einen detaillierten Projektplan mit konkreten Zielen und einem Budget für Projektaktivitäten (Maßnahmen), wie z.B. Fortsetzung der künstlerisch-kulturellen Arbeit, berufliche Fortbildungen, Sprachkurse, psychosoziale Begleitung etc. Bitte stellen Sie sicher, dass Sie sich mit Ihrer potenziellen Gastorganisation über die im Formular aufgeführten Projektaktivitäten sowie das Budget des Projekts abstimmen.<br><br/>Wir weisen nachdrücklich darauf hin, dass die Unterstützung der MRI aufgrund des zeitlich begrenzten Charakters unseres Programms nach Ablauf der Stipendienlaufzeit endet. <br><br/>Ihr Hauptansprechpartner während der Antragsphase und, im Falle einer Bewilligung, während der gesamten Stipendienlaufzeit ist die Gastorganisation. Bitte beachten Sie, dass es innerhalb jeder Stipendienlaufzeit drei obligatorische Treffen (zu Beginn, in der Mitte und am Ende des Aufenthalts) zwischen Stipendiat:in, Gastorganisation und der MRI gibt, um Stärkungsstrategien und -maßnahmen zu vereinbaren.<br><br/>Bitte beachten Sie, dass Sie die Gastorganisation und das MRI direkt informieren müssen, wenn die Daten in Ihrem Personal Statement nicht mehr aktuell sind. Dies ist besonders wichtig in Bezug auf die Angaben zu Ihrer Kontaktperson für Notfälle.<br><br/>Bitte beachten Sie, dass kein Rechtsanspruch auf eine Förderung durch die MRI besteht. Die MRI kann nur vollständige Anträge bearbeiten. Nach einer formalen Prüfung aller eingereichten Unterlagen entscheidet ein unabhängiges Gremium, bestehend aus Mitgliedern der Kunst- und Kulturszene und Vertretern zivilgesellschaftlicher Institutionen, über die Vergabe der Fördermittel für die beantragten Projekte.<br><br/>Bitte nehmen Sie sich die Zeit, die untenstehenden Fragen gründlich zu beantworten und zögern Sie nicht, sich bei weiteren Fragen mit uns in Verbindung zu setzen.<br><br/>Falsche und/oder unvollständige Angaben sowie das Weglassen wichtiger Informationen können zum Entzug des Stipendiums führen, wobei es keinen Unterschied macht, ob die Angaben absichtlich oder versehentlich oder unvollständig gemacht bzw. zurückgehalten wurden.<br><br/>Achten Sie bitte darauf, Ihre Änderungen regelmäßig zu speichern. Wichtig ist zudem, dass Sie Ihre Änderungen immer speichern, bevor Sie die Sitzung verlassen und bevor Sie das Formular finalisieren. Bitte klicken Sie erst auf -FINALISIEREN-, wenn Sie Ihr Personal Statement komplett fertiggestellt haben.",
  ...
  common_title_title: "Titel",
  common_title_choice_1: "Keine Auswahl",
  common_title_choice_2: "Herr",
  common_title_choice_3: "Frau",
  common_title_choice_4: "Divers",
  ...
  PS_1_others_7:
    "HIERMIT BESTÄTIGE ICH, DASS ICH UND DIE VON MIR ANGEGEBENEN PERSONEN UND KONTAKTE DIE DATENSCHUTZHINWEISE IN DEN <a href='https://martin-roth-initiative.de/de/antragsverfahren#pid-112' target='_blank'>INFORMATIONEN ZUM DATENSCHUTZ UND ZUR VERARBEITUNG IHRER PERSONENBEZOGENEN DATEN GEM. DS-GVO</a> ERHALTEN UND ZUR KENNTNIS GENOMMEN HABEN (ERFORDERLICH FÜR DIE ANTRAGSTELLUNG).",
  ...
  PS_1_risk_references_description:
    "Bitte hängen Sie an Ihre persönliche Erklärung Referenzen an, die dazu geeignet sind, Ihre Sicherheitsbedenken zu belegen (beispielsweise Presseartikel, Dokumentationen, Links, etc.).",
  PS_1_risk_pr_title: "3.3. Öffentlichkeitsarbeit",
  PS_1_risk_pr_description:
    "Ist es möglich, dass Sie als Stipendiat:in der Martin Roth-Initiative öffentlich auftreten? Berücksichtigen Sie an dieser Stelle bitte auch sicherheitsrelevante Implikationen für Sie und Ihre Angehörigen.",
  ...
  PP_1_project_current_situation_title: "3.1. Ausgangslage",
  ...
  PS_1_risk_description_description:
    "Die Martin Roth-Initiative unterstützt Künstler:innen, die sich (mit ihrem künstlerischen Schaffen) für eine offene Gesellschaft, Freiheit, Frieden und Demokratie einsetzen und aufgrund ihres Engagements oder aus anderen Gründen Beschränkungen ihrer Freiheit bzw. Bedrohungen durch staatliche und/oder nicht-staatliche Akteure erfahren. Bitte beschreiben Sie Ihre individuelle Sicherheitssituation so konkret wie möglich und nennen Sie spezifische Vorfälle und Daten. Fügen Sie gerne weitere allgemeine Informationen über die politische Situation in Ihrem Land hinzu, wenn Sie dies für relevant halten.",
  ...
  PP_1_project_relocation_description:
    "Das Projektziel „Stipendiat:in ist temporär außerhalb des Gefährdungskontexts und sicher“ ist vorgegeben. Die untenstehenden Maßnahmen und Erfolgsindikatoren sind daher obligatorisch umzusetzen bzw. zu erreichen. Erläutern Sie bitte im untenstehenden Feld, ob bzw. wie Sie den Aufgaben nachkommen können bzw. wollen und welche Erfahrungen Sie dahingehend ggf. schon vorweisen können.<br/><br/><b>Maßnahmen</b><br /><b>(a) </b>Die Gastorganisation (GO) unterstützt beim Visaprozess und koordiniert bzw. begleitet den Prozess zum Erhalt einer gültigen Aufenthaltserlaubnis (Unterstützung bei Behördengängen).<br /><b>(b) </b>GO kümmert sich gemeinsam mit der:dem Stipendiat:in um die Reisevorbereitungen bzw. -umsetzung.<br /><b>(c) </b>GO stellt einen angemessenen Wohnraum zur Verfügung bzw. kümmert sich um die Sicherstellung eines angemessenen Wohnraums.<br /><b>(d) </b>GO kümmert sich um die Recherche und Auswahl einer bedarfsgerechten Krankenversicherung. GO unterstützt im Bedarfsfall den Zugang zu medizinischer Versorgung.<br /><b>(e) </b>GO setzt einen rechtssicheren Stipendienvertrag auf und schließt diesen mit dem:der Stipendiat:in ab. GO zahlt monatlich pünktlich das Stipendium aus.<br /><b>(f) </b>GO und Stipendiat:in verpflichten sich, an drei Feedbackgesprächen (zu Beginn, zur Mitte und zum Ende des Stipendienzeitraums) mit der MRI teilzunehmen, um fortlaufend belastbare Maßnahmen u.a. zu den Themen Stärkungsstrategien und Öffentlichkeitsarbeit zu vereinbaren.<br /><b>(g) </b>GO stellt dem:der Stipendiat:in mind. eine Ansprechperson für den gesamten Verlauf des Projekts zur Verfügung.<br /><br /><b>Erfolgsindikatoren</b><br /><b>(a) </b>Stipendiat:in hatte während des Projektzeitraums rechtlich gesicherten Zugang in Deutschland; D-Visum und Aufenthaltserlaubnis wurden erteilt (amtliche Dokumente, Reisedokumente, etc. sind ggf. nach Aufforderung als Nachweis vorzuzeigen).<br /><b>(b) </b>Reiseumsetzung hat stattgefunden (Darlegung im Sachbericht; Reisedokumente sind ggf. nach Aufforderung als Nachweis vorzuzeigen).<br /><b>(c) </b>Angemessener Wohnraum stand für den gesamten Projektzeitraum zur Verfügung. (Darlegung im Sachbericht; ggf. Mietvertrag, o.ä. sind ggf. nach Aufforderung als Nachweis vorzeigen).<br /><b>(d) </b>Stipendiat:in hatte Zugang zu medizinischer Versorgung (Vertrag der Krankenversicherung; Einzahlungen sind ggf. nach Aufforderung als Nachweis vorzuzeigen. Es müssen selbstverständlich keine Angaben/Details zu Krankheiten, Behandlungen, etc. gemacht werden.)<br /><b>(e) </b>Stipendiat:in war während des gesamten Projektzeitraums finanziell abgesichert. Stipendium/Gehalt wurde monatlich pünktlich ausbezahlt (Stipendienvertrag; Überweisungsnachweise sind ggf. nach Aufforderung als Nachweis vorzuzeigen).<br /><b>(f) </b>Drei Feedbackgespräche mit Stipendiat:in und MRI fanden statt; Vereinbarungen wurden getroffen und eingehalten.<br /><b>(g) </b>Es gab eine über den gesamten Projektverlauf eine direkte Ansprechperson bei der Gastorganisation, die die:den Stipendia:tin unterstützt hat. Es fand ein regelmäßiger Austausch zwischen GO und Stipendiat:in zum Inhalt des Projekts, zu den Zielen und dem Projektfortschritt statt. <br /><br />Erläutern Sie bitte, ob bzw. wie Sie den o.g. Aufgaben nachkommen können und welche Erfahrungen Sie dahingehend ggf. vorweisen können.",
  ...
  PP_1_declaration_7:
    "Hiermit bestätige ich, dass ich und die in diesem Antrag angegebenen Personen und Kontakte die Datenschutzhinweise in den <a href='https://martin-roth-initiative.de/de/antragsverfahren#pid-112' target='_blank'>Informationen zum Datenschutz und zur Verarbeitung Ihrer personenbezogenen Daten gem. DS-GVO</a> erhalten und zur Kenntnis genommen haben (erforderlich für die Antragstellung).",
  PP_1_declaration_8:
    "Hiermit willige ich in die Verarbeitung meiner personenbezogenen Daten für folgende Zwecke ein: (a) zur Zusendung (telefonisch/postalisch/digital) von Einladungen und Mitteilung über Veranstaltungen (auch über den Förderzeitraum hinaus) und (b) für Zusendungen/Mitteilungen (telefonisch/schriftlich/digital) von relevanten Informationen bspw. zur Martin Roth-Initiative (auch über den Förderzeitraum hinaus)",
  PP_1_declaration_9:
  ...
  PS_1_other_relatives_title: "5.1. Familienangehörige",
  ...
  PS_1_other_support_title: "5.2. Unterstützung",
  ...
  PS_1_other_funding_contact_title: "5.3. Kontakt zu anderen Förderprogrammen",
  ...
  PS_1_other_further_title: "5.4. Weitere Informationen",
  ...
  PP_1_declaration_signatory_title:
    "Erklärung der zeichnungsberechtigten Person",
  PP_1_declaration_signatory_description:
    "<br/>Die unterzeichnende Person bestätigt hiermit die Korrektheit der obenstehenden Angaben und erklärt, dass die Maßnahmen, die Gegenstand dieses Antrags sind und deren Umsetzung aus den beantragten Mitteln finanziert werden soll, nicht von anderer Seite finanziert werden. Das Konzept wird auch nicht an anderer Stelle zur Finanzierung eingereicht. Eine Finanzierung des Projektes kann nicht mithilfe anderer Finanzmittel erfolgen.</b><br/><br/><br/><br/><br/>__________________________________________________<br/>Ort und Datum<br/><br/><br/><br/>__________________________________________________<br/>Name und Funktion der unterschreibenden Person<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>__________________________________________________________________________________________________________________<br/>Unterschrift und Stempel<br/><br/>Bitte finalisieren Sie Ihren vollständigen Antrag und senden Ihn nach Aufforderung rechtsverbindlich unterschrieben per Post an nachstehende Anschrift:<br/><br/><b>Martin Roth-Initiative<br/>Linienstr. 139/140<br/>D-10115 Berlin<br/></b><br/><br/>Bitte beachten Sie, dass kein Rechtsanspruch auf Gewährung von Zuschüssen durch die MRI besteht. Nur vollständige Anträge werden bearbeitet. Nach der formellen Prüfung aller eingereichten Unterlagen durch die Martin Roth-Initiative entscheidet ein unabhängiges Gremium, bestehend aus Mitgliedern der Kunst- und Kulturszene sowie aus Vertreter:innen zivilgesellschaftlicher Institutionen, über die Gewährung von Zuschüssen für beantragte Projekte.",
};
