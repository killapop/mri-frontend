export const form = {
  ...
  PP_1_project_relocation_description:
    "Un objectif obligatoire du projet est de s'assurer que le boursier est temporairement hors du contexte de risque et en sécurité. Les mesures et les indicateurs de résultats énumérés ci-dessous doivent donc être mis en œuvre/atteints à la suite du projet. Veuillez expliquer dans le champ ci-dessous comment vous prévoyez de mettre en œuvre ces mesures et toute expérience que vous pouvez déjà avoir à cet égard.<br/><br/>Veuillez expliquer comment vous prévoyez de mettre en œuvre les mesures susmentionnées et toute expérience que vous pouvez déjà avoir à cet égard.",
