export const data = [
  {
    ...
    beneficiaries: [
      {
        full_name: 'Jilleen Yeldham'
      },
      {
        full_name: 'Bord Jopp'
      },
      {
        full_name: 'Burk Bowie'
      },
      {
        full_name: 'Maude Wolfer'
      }
    ],
  ...
  },
  {
    ...
    beneficiaries: [
      {
        full_name: 'Barthel Seabert'
      },
      {
        full_name: 'Rhona Brommage'
      }
    ],
  ...
  },
  {
    ...
    beneficiaries: [
      {
        full_name: 'Darci Aurelius'
      },
      {
        full_name: 'Cris Waywell'
      }
    ],
  ...
  },
  {
    ...
    beneficiaries: [
      {
        full_name: 'Vachel Fransson'
      },
      {
        full_name: 'Katrinka Lammin'
      }
    ],
  ...
  },
  {
    ...
    beneficiaries: [
      {
        full_name: 'Lizette Baldocci'
      },
      {
        full_name: 'Nadya Zecchi'
      }
    ],
  ...
  },
  {
    ...
    beneficiaries: [
      {
        full_name: 'Lyndsie Paulucci'
      },
      {
        full_name: 'Randene Maharey'
      }
    ],
  ...
  },
  {
    ...
    beneficiaries: [
      {
        full_name: 'Chiarra Skeleton'
      },
      {
        full_name: 'Hilly Kinkead'
      }
    ],
